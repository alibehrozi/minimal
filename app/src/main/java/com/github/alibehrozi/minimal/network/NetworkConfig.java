...
import com.github.alibehrozi.minimal.network.core.Context;
import com.github.alibehrozi.minimal.network.core.EventTarget;
import com.github.alibehrozi.minimal.network.core.RunLoop;
 ...
 */
public class NetworkConfig extends Context {
     ...
     * Runnable Runnable} for each callback.
     *
    ...
    public synchronized void setPersistenceCacheSizeBytes(long cacheSizeInBytes) {
        ...
        if (cacheSizeInBytes < 1024 * 1024) {
            throw new NetworkException("The minimum cache size must be at least 1MB");
        }
