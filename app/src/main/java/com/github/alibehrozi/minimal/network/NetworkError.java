...
public class NetworkError {
     ...
     */
    public static NetworkError fromStatus(String status) {
     ...
     * @return An error corresponding the to the status
     */
    public static NetworkError fromStatus(String status, String reason) {
     ...
     */
    public static NetworkError fromCode(int code) {
        ...
        return new NetworkError(code, message, null);
    }
     ...
     * @return An error corresponding the to the status
     */
    public static NetworkError fromStatus(String status, String reason, String details) {
    ...
    @NotNull
    public static NetworkError fromException(@NotNull Throwable e) {
        StringWriter stringWriter = new StringWriter();
        PrintWriter printWriter = new PrintWriter(stringWriter);
        e.printStackTrace(printWriter);
        String reason = errorReasons.get(USER_CODE_EXCEPTION) + stringWriter;
        return new NetworkError(USER_CODE_EXCEPTION, reason);
    }
    ...
    private NetworkError(int code, String message) {
        this(code, message, null);
    }

    private NetworkError(int code, String message, String details) {
        this.code = code;
    ...
    public NetworkException toException() {
        return new NetworkException("Firebase Database error: " + message);
    }
}