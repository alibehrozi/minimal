...
package com.github.alibehrozi.minimal.network.core.encoding;

import static com.github.alibehrozi.minimal.network.core.Utilities.hardAssert;
...
public class CustomClassMapper {
    ...
    private static <T> Object serialize(T o) {
        if (o == null) {
            ...
            throw new NetworkException("Characters are not supported, please use Strings");
            ...
            for (Map.Entry<Object, Object> entry : ((Map<Object, Object>) o).entrySet()) {
                ...
                if (key instanceof String) {
                    ...
                    throw new NetworkException("Maps with non-string keys are not supported");
                }
            }
            return result;
    ...
    private static <T> T deserializeToType(Object o, Type type) {
        if (o == null) {
            ...
            if (lowerBounds.length > 0) {
                throw new NetworkException("Generic lower-bounded wildcard types are not supported");
            }
    ...
    private static <T> T deserializeToParameterizedType(Object o, ParameterizedType type) {
        ...
        if (List.class.isAssignableFrom(rawType)) {
            ...
            throw new NetworkException("Collections are not supported, please use Lists instead");
        } else {
            Map<String, Object> map = expectMap(o);
    ...
    private static class BeanMapper<T> {
        ...
        public BeanMapper(Class<T> clazz) {
            ...
            for (Method method : clazz.getMethods()) {
                if (shouldIncludeGetter(method)) {
                    ...
                    if (getters.containsKey(propertyName)) {
                        throw new NetworkException("Found conflicting getters for name: " + method.getName());
                    }
            ...
            if (properties.isEmpty()) {
                throw new NetworkException("No properties to serialize found on class " + clazz.getName());
            }
        }
