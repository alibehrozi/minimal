...
public abstract class DefaultRunLoop implements RunLoop {
    ...
    public static String messageForException(Throwable t) {
        if (t instanceof OutOfMemoryError) {
            ...
            return "Uncaught exception in runloop ("
                    + "). If you are not already on the latest version, try updating "
                    + "your dependencies. Should this problem persist";
        }
    }
}