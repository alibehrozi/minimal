...
class MessageBuilderFactory {
    ...
    interface Builder {
        ...
        SocketMessage toMessage();
    }

    static class BinaryBuilder implements Builder {
        private final List<byte[]> pendingBytes;
    ...
    static class TextBuilder implements Builder {
        private static final ThreadLocal<CharsetDecoder> localDecoder =
        ...
        private static final ThreadLocal<CharsetEncoder> localEncoder =
        ...
        public SocketMessage toMessage() {
            ...
            return new SocketMessage(builder.toString());
        }
    ...
    static Builder builder(byte opcode) {
        if (opcode == Socket.OPCODE_BINARY) {
